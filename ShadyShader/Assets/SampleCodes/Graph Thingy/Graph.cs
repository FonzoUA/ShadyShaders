...
public class Graph : MonoBehaviour
{
    ...
    public GraphFunctionsName functionName;

    const float pi = Mathf.PI;
    private Transform[] temp;
    private static GraphFunctions[] functions =
    {
        ErrorLog,
        SineFunction,
        MultiSineFunction,
    ...
    private void Awake()
    {
        temp = new Transform[numPoints * numPoints];
        step = 2f / numPoints;
    ...
    private static Vector3 ErrorLog(float x, float z, float t)
    {
        Debug.LogError("No function selected");
        return Vector3.zero;
    }
}
