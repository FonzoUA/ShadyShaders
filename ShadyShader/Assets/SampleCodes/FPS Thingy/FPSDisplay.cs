...
public class FPSDisplay : MonoBehaviour
{
    ...
    private void Update()
    {
        Display(AverageDisplay, fpsCounter.AverageFPS);
        Display(HighestDisplay, fpsCounter.HighestFPS);
        Display(LowestDisplay, fpsCounter.LowestFPS);
    }

    private void Display(Text text, int fps)
    {
